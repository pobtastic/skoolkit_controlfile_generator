...
IY_CB_BITS = {
    0x0E: "Rotate *#REGiy+#N${:02X} right (with carry)",
    0x16: "Rotate *#REGiy+#N${:02X} left",
    0x1E: "Rotate *#REGiy+#N${:02X} right",
    0x26: "Shift *#REGiy+#N${:02X} left (with carry)",
    0x3E: "Shift *#REGiy+#N${:02X} right",
    0x46: "Test bit 0 of *#REGiy+#N${:02X}",
    0x4E: "Test bit 1 of *#REGiy+#N${:02X}",
    0x56: "Test bit 2 of *#REGiy+#N${:02X}",
    0x5E: "Test bit 3 of *#REGiy+#N${:02X}",
    0x66: "Test bit 4 of *#REGiy+#N${:02X}",
    0x6E: "Test bit 5 of *#REGiy+#N${:02X}",
    0x76: "Test bit 6 of *#REGiy+#N${:02X}",
    0x7E: "Test bit 7 of *#REGiy+#N${:02X}",
    0x86: "Reset bit 0 of *#REGiy+#N${:02X}",
    0x8E: "Reset bit 1 of *#REGiy+#N${:02X}",
    0x96: "Reset bit 2 of *#REGiy+#N${:02X}",
    0x9E: "Reset bit 3 of *#REGiy+#N${:02X}",
    0xA6: "Reset bit 4 of *#REGiy+#N${:02X}",
    0xAE: "Reset bit 5 of *#REGiy+#N${:02X}",
    0xB6: "Reset bit 6 of *#REGiy+#N${:02X}",
    0xBE: "Reset bit 7 of *#REGiy+#N${:02X}",
    0xC6: "Set bit 0 of *#REGiy+#N${:02X}",
    0xCB: "Set bit 1 of *#REGiy+#N${:02X} and store the result in #REGe",
    0xCE: "Set bit 1 of *#REGiy+#N${:02X}",
    0xD6: "Set bit 2 of *#REGiy+#N${:02X}",
    0xDE: "Set bit 3 of *#REGiy+#N${:02X}",
    0xE6: "Set bit 4 of *#REGiy+#N${:02X}",
    0xEE: "Set bit 5 of *#REGiy+#N${:02X}",
    0xF6: "Set bit 6 of *#REGiy+#N${:02X}",
    0xFE: "Set bit 7 of *#REGiy+#N${:02X}",
}
